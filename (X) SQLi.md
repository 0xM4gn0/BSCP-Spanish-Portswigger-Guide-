# 🛡️ SQL Injection Cheat Sheet 🛡️

## 📌 Índice
1. [Ataques UNION](#-ataques-union)
2. [Recuperación de datos](#-recuperación-de-datos)
3. [Consultas de versión BD](#-consultas-de-versión-de-bd)
...
**Técnica**: Añade `NULL` hasta que la consulta sea válida

' UNION SELECT NULL,NULL--

# 📌 SQL injection UNION attack - Columnas con texto
...
# 🔓 SQL injection - Recuperar datos de otras tablas
...
# 🗃️ Recuperar múltiples valores en una columna
...
# 🏷️ Consultar versión de BD (Oracle)
...
# 🏷️ Consultar versión (MySQL/Microsoft)
...
# ⏱️ Blind SQL injection con dealy
...
# ⏱️ Blind SQLi con delays y devolución de info
